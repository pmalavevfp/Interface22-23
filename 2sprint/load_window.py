...
class LoadWindow (Gtk.Window):
    ...
    con la activacion del cierre de ventana y progrma de que la llama 
    por el destroy, y se gener el spinner para mostrar que se esta cargando 
    las imagenes"""
    def __init__ (self):
    ...
    """instanciar y mostrar la ventana principal. En segundo lugar, cerrar
la ventana de carga:"""
